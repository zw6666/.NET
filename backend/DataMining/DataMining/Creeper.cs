...
namespace DataMining
{
    ...
    public static class Creeper
    {
        ...
        public static List<Singer> GetSingers()
        {
            ...
            var singerlist = Pagejson["singerList"]["data"]["singerlist"] as JArray;
            foreach (var item in singerlist)
            {

                singers.Add(new Singer(item["singer_name"].ToString(), item["singer_pic"].ToString().Replace(".webp", ".jpg")));
